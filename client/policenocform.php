...
<div class="row" style="display:flex;">
    ...
    <table width="100%">
        <tbody>
            ...
            <tr>
                ...
                <td style="width:48%">घर मालकाचे संपूर्ण नाव, सध्याचा पत्ता, वय, मोबाईल क्रमांक <br>Owner Full Name,
                    Address,Age & Mobile No. of Owner</td>
                <?php 
                ...
                <td colspan="3"><label><?php echo $arr['fullname'];?></label></br>
                    ...
                    <label><?php echo $arr['mobile'];?></label>
                </td>
            ...
            <tr>
                <?php 
						...
						?>
                <td>३</td>
                <td>भाडेकरुचे संपूर्ण नाव, यापूर्वीचा पत्ता, वय, मोबाईल क्रमांक<br>Tenant Name, Previous Address &
                    Mobile No. of Tenant</td>
                <td colspan="3"><label><?php echo $arr['fullname'];?></label></br>
                    <label><?php echo $arr['address'];?></label></br>
                    <label><?php echo $arr['mobile'];?></label>
                </td>
            ...
            <tr>
                ...
                <td colspan="3"><label><?php echo $arr['agent_name'];?></label><br>
                    ...
                    <?php echo $arr['mobile_no'];?></label><br>
                </td>
                <?php } ?>
            ...
            <tr>
                <td>१३</td>
                <td>भाडेकरुला ओळखणाऱ्या दोन व्यक्तीचे संपूर्ण नाव, पत्ता, मोबाईल क्रमांक <br>Two persons reference with
                    Address & Mobile No.</td>
                <td colspan="3"><label><?php echo $arr['name1'];?></label><br>
                    <label><?php echo $arr['name2'];?></label>
                </td>
            </tr>
            <?php } ?>
            <tr>
                ...
                <td colspan="3">Start Date:-&nbsp;<label><?php $input=$arr['date_of_agreement']; $date=strtotime($input);
                    ...
                    <label><?php echo $arr['no_of_month'];?>&nbsp;Months</label>
                </td>
                <?php } ?>
    ...
    <div style="width: 100%;">
        ...
        <div style="margin-left: 50%;">
            ...
            <p>३) मूळ वास्तव्याचा पुरावा [मतदान ओळखपत्र, पासपोर्ट, ग्रामपंचायत दाखला , शाळेचा दाखला , रेशनकार्ड यापैकी
                कोणतेही एक]</p>
    ...
    <p align="center">वरील भरुन दिलेली माहिती ही खरी असून त्यामध्ये काही खोटे आढळल्यास भी कायदेशीर कार्यवाहीस पात्र
        राहिन.</p>
    <p align="center">टिप:- सदर माहितीचा / फॉर्मचा उपयोग केवळ पोलीसांच्या रेकॉर्डसाठी असून अन्य कोणत्याही कारणासाठी
        पुरवा म्हणून वापरता येणार नाही. </p>
