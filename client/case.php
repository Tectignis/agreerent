            ...
            <div class="card">
              ...
              <div class="card-tools">
                <ul class="nav nav-pills ml-auto">
                  <li class="nav-item">
                    <a class="nav-link active" href="newagreement" data-tt="tooltip" title="" data-original-title="Click here to Add New Enquiry"><i class="fas fa-user-friends mr-2"></i>Create New Agreement</a>
                  </li>
                </ul>
              </div>
              </div>
                    ...
                    <div class="col-md-12">
                        <nav>
                            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Pending Cases</a>
                                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Complete</a>
                            </div>
                        </nav>
...
if($newdoc!=$owdoc || $newdoc!=$tdoc || $newdoc!=$memdoc || $newdoc!=$amdoc || $newdoc!=$pdoc){
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="listofagreement.php?viewid=<?php echo $row['newdoc'];?>"  class="btn btn-primary btn-rounded btn-icon"><i class="fas fa-eye"></i></a>
                                        <a href="edit_newagreement.php?id=<?php echo $row['newdoc'];?>"  class="btn btn-warning btn-rounded btn-icon" style="color: aliceblue"><i class="fas fa-pen"></i></i></a>
                                    <a href="listofagreement.php?eid=<?php echo $row['newdoc'];?>"  class="btn btn-success btn-rounded btn-icon"> Generate NOC</a></td>
                                        </tr>
                                       <?php } $count++; } ?>
                                    </tbody>
                                </table>
