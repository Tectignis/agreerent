                  ...
                  <tbody>
                    ...
                    while($arr=mysqli_fetch_array($sql)){
                      ?>
                                                ...
                                                <td>  <a href="receipt.php?id=<?php echo $arr['document_no'] ?>"target="_blank"><button type="button" class="btn btn-primary btn-rounded btn-icon" style="color: aliceblue">  <i class="fas fa-eye"></i> </button></a></td>
                                              </tr>
                                   <?php $count++; }  ?>
                                          </tbody>
