        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="forms-sample" method="post" enctype="multipart/form-data" style="margin:30px;">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <textarea name="office_address" style="width:100%;" rows="2" placeholder="Enter Address"required></textarea>
              </div>
            </div>
            <div class="form-group row">
