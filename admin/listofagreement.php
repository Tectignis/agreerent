      ...
      ?>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="agreement.php?id=<?php echo $row['did']; ?>"> <button
                                                            type="btn-icon" class="btn btn-primary btn-rounded btn-icon"
                                                            style="color: aliceblue"> <i class="fas fa-eye"></i>
                                                        </button></a>
...
?>
                                                    <a href="agreement.php?id=<?php echo $row['did']; ?>"> <button
                                                            type="btn-icon" class="btn btn-warning btn-rounded btn-icon"
                                                            style="color: aliceblue"> <i class="fas fa-pen"></i>
                                                        </button></a>
                                                    <a href="listofagreement.php?gen=<?php echo $row['did']; ?>"><button
                                                            type="submit" class="btn btn-success btn-rounded btn-icon"
                                                            style="color: aliceblue"> Generate NOC</button> </a>
                                                    <?php
}
?>
                                                </td>
