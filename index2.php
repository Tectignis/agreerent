  ...
  <body>
      <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      <div class="modal-header"style="text-align:center;">
                        <h3 class="modal-title" id="exampleModalLabel" style="text-align:center;">Register For Demo</h3>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>

                      <div class="container my-0 register card-body">
                    
                      <div class="row">
                        <div class="col-md-3 p-3 register-left">
                        <img src="logo1.png" style="width:100%"  alt=""/>
                        <h3>Welcome To Tectignis IT Solutions</h3>
                        <p>You are 30 seconds away from earning your own money!</p>
                        <!-- <input type="submit" name="" value="Login"/><br/> -->
                        
                      </div>
                      <div class="col-md-9 p-0 register-right">
                ...
                <div class="my-3 d-flex justify-content-center align-items-center">
                          <input type="submit" class="main-btn px-5 btn  font-weight-bold auth-form-btn" value="Submit" name="login">
                </div>
