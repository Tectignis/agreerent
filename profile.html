        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <form>
                <div class="card-body">
                  <div class="tab-pane fade show active" id="custom-tabs-consultant-setting" role="tabpanel" aria-labelledby="custom-tabs-consultant-setting-tab">
                      <div class="form-group row">
                        <label for="inputEmail1" class="col-sm-2 col-form-label">Client Code<span class="text-danger"></span></label>
                        
                        <div class="col-sm-4">
                          <input type="text" name="client_code" class="form-control form-control-sm field_validation" id="client_code" placeholder="Client  Code">                         
                        </div>
                      </div>                      
					  <div class="form-group row">
                        <label for="inputEmail2" class="col-sm-2 col-form-label">Firm Name<span class="text-danger"></span></label>
                        
                        <div class="col-sm-4">
                          <input type="text" name="firm_name" class="form-control form-control-sm field_validation" id="firm_name" placeholder="Firm Name">                          <span id="err_firm_name" class="error invalid-feedback"><!--  --></span>
                        </div>
                      </div>					  
					  <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Authorized Person Name<span class="text-danger"></span></label>
                        
                        <div class="col-sm-4">
                          <input type="text" name="authorized_name" class="form-control form-control-sm field_validation" id="authorized_name" placeholder="Authorized Person Name">                          <span id="err_authorized_name" class="error invalid-feedback"><!--  --></span>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputPassword3" class="col-sm-2 col-form-label">Email<span class="text-danger"></span></label>
                        <div class="col-sm-4">
                          <input type="text" name="email"  class="form-control form-control-sm field_validation" id="email" placeholder="Email">                          <span id="err_email" class="error invalid-feedback"><!--  --></span>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputPassword3" class="col-sm-2 col-form-label">Phone<span class="text-danger"></span></label>
                        <div class="col-sm-4">
                          <input type="text" name="mobile" class="form-control form-control-sm field_validation" id="mobile" placeholder="Phone">                          <span id="err_mobile" class="error invalid-feedback"><!--  --></span>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputPassword3" class="col-sm-2 col-form-label">Country<span class="text-danger"></span></label>
                        <div class="col-sm-4">
                         <select class="form-control form-control-sm select2bs4 field_validation select2-hidden-accessible"  name="country_id" id="country_id" width="100%" tabindex="-1" aria-hidden="true" data-select2-id="country_id">
                                ...
                                Zimbabwe                              </option>
                                                      ...
                                                      </select><span class="select2 select2-container select2-container--bootstrap4" dir="ltr" data-select2-id="256" style="width: 527.328px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-country_id-container">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <select class="form-control form-control-sm select2bs4 field_validation select2-hidden-accessible" name="state_id" id="state_id" width="100%" placeholder="State" tabindex="-1" aria-hidden="true" data-select2-id="state_id">
                                                          <option value="1">
							...
							<span class="select2 select2-container select2-container--bootstrap4" dir="ltr" data-select2-id="294" style="width: 527.328px;"><span class="selection">
								<span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-state_id-container">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <select class="form-control form-control-sm select2bs4 field_validation select2-hidden-accessible" name="city_id" id="city_id" width="100%" tabindex="-1" aria-hidden="true" data-select2-id="city_id">
                                                          <option value="3551">
                                Abiramam                              </option>
							...
							<span class="select2 select2-container select2-container--bootstrap4" dir="ltr" data-select2-id="1186" style="width: 527.328px;">
							<span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-city_id-container"><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputPassword3" class="col-sm-2 col-form-label">Address Line1</label>
                        <div class="col-sm-4">
                          <input type="text" name="address_line1" class="form-control form-control-sm field_validation" id="address_line1" placeholder="Address Line1">
                          <span id="err_address_line1" class="error invalid-feedback"><!--  --></span>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputPassword3" class="col-sm-2 col-form-label">Address Line2</label>
                        <div class="col-sm-4">
                          <input type="text" name="address_line2" class="form-control form-control-sm" id="address_line2" placeholder="Address Line2">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputPassword3" class="col-sm-2 col-form-label">Pincode<span class="text-danger"></span></label>
                        <div class="col-sm-4">
                          <input type="text" name="pincode" class="form-control form-control-sm field_validation" id="pincode" placeholder="Pincode">                          <span id="err_pincode" class="error invalid-feedback"><!--  --></span>
                        </div>
                      </div>
                    </div>
                </div>
